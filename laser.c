...
static enum laserControl_st_t {
    init_st,
    play_st
} currentState, nextState;

// it adds an laser. What's there to explain?
struct Laser* laser_addLaser(int16_t myX, int16_t myY, int8_t myXVelocity, int8_t myYVelocity) {
...
// standard tick function, capable of adding, drawing, moving, and destroying lasers
void laser_tick() {
